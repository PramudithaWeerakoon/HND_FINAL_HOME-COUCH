        ...
        children: [
          ...
          Padding(
            ...
            child: Container(
              ...
              height: 400, // Set a fixed height for the camera preview
...
Column(
  ...
  children: [
    Row(
      ...
      crossAxisAlignment: CrossAxisAlignment.end, // Align to the bottom of the row
      children: [
        Stack(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: const Color(0xFF21007E), // Background color
              ),
              child: Text(
                '$repCount / 10',
                style: TextStyle(
            ...
            Positioned(
              bottom: -20, // Move the box further down
              child: Container(
